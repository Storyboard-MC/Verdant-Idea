ServerEvents.recipes(event => {
  ...
  event.recipes.botania.runic_altar('mysticalagriculture:tin_seeds', ['mysticalagriculture:prosperity_seed_base', 'immersiveengineering:coke', 'minecraft:iron_block', 'botania:white_petal_block'].concat('botania:rune_earth').concat('botania:rune_water').concat(multi(essence, 4)), manaCost)
