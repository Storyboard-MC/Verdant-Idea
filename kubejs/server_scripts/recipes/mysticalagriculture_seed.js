ServerEvents.recipes(event => {
  ...
  event.recipes.botania.runic_altar('mysticalagriculture:coal_seeds', ['mysticalagriculture:prosperity_seed_base', '#wasteland:coal_blocks', 'botania:black_petal_block', 'botania:gray_petal_block'].concat(multi(essence, 4)), manaCost)
  ...
  event.recipes.botania.runic_altar('mysticalagriculture:tin_seeds', ['mysticalagriculture:prosperity_seed_base', 'immersiveengineering:coke', combBlock('tin'), 'botania:white_petal_block'].concat('botania:rune_earth').concat('botania:rune_water').concat(multi(essence, 4)), manaCost)
  ...
  event.recipes.botania.runic_altar('mysticalagriculture:aluminum_seeds', ['mysticalagriculture:prosperity_seed_base', combBlock('aluminum'), 'botania:white_petal_block', 'mysticalagriculture:dye_essence', 'mysticalagriculture:dye_essence'].concat('botania:rune_air').concat('botania:rune_winter').concat(multi(essence, 4)), manaCost)
  event.recipes.botania.runic_altar('mysticalagriculture:diamond_seeds', ['mysticalagriculture:prosperity_seed_base', 'mekanism:block_tin', 'botania:light_blue_petal_block', 'minecraft:diamond', 'minecraft:diamond'].concat('botania:rune_water').concat('botania:rune_summer').concat(multi(essence, 4)), manaCost)
  ...
  event.recipes.botania.runic_altar('mysticalagriculture:silver_seeds', ['mysticalagriculture:prosperity_seed_base', 'minecraft:copper_block', 'botania:light_gray_petal_block', combBlock('silver'), 'botania:light_blue_petal_block'].concat('botania:rune_fire').concat('botania:rune_spring').concat(multi(essence, 4)), manaCost)
  ...
  event.recipes.botania.runic_altar('mysticalagriculture:nickel_seeds', ['mysticalagriculture:prosperity_seed_base', 'botania:brown_petal_block', 'immersiveengineering:storage_nickel', 'botania:white_petal_block', 'minecraft:iron_block'].concat('botania:rune_winter').concat('botania:rune_greed').concat('botania:rune_sloth').concat(multi(essence, 4)), manaCost)
  event.recipes.botania.runic_altar('mysticalagriculture:osmium_seeds', ['mysticalagriculture:prosperity_seed_base', 'botania:light_gray_petal_block', 'botania:light_blue_petal_block', 'immersiveengineering:storage_nickel', 'minecraft:copper_block'].concat('botania:rune_winter').concat('botania:rune_greed').concat('botania:rune_lust').concat(multi(essence, 4)), manaCost)
